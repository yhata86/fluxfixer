...
\`calc_dtmax_pd_ed()\` calculates the time series of dTmax (the maximum
temperature difference between sap flow probes under zero-flow
conditions) using the daily predawn and the environmental dependent
methods.
...
- vctr_time:
  ...
  A timestamp vector of class POSIXct or POSIXlt. This vector indicates
...
- Oishi A. C., Hawthorne, D. A. & Oren, R. (2016) Baseliner: An
  open-source, interactive tool for processing sap flux data from
  thermal dissipation probes. SoftwareX, 5, 139-143.
  [doi:10.1016/j.softx.2016.07.003](https://doi.org/10.1016/j.softx.2016.07.003)
